	...
	*/
	...
	useEffect(() => {
		const loadUsers = async () => {
			try {
				const URL = `https://autocomplete.geocoder.ls.hereapi.com/6.2/suggest.json?query=${ encodeURIComponent(textValue) }&maxresults=${ MAX_RESULT }&apikey=bi5eUoMwDNyvKhtBWEyMfc5zD6qpsblwPi1OTINYBEg`;
